...
def test_task_completion_on_report_upload_failure(module_target_sat, function_org):
    """Verify that the HostInventoryReportJob stops successfullly instead of timing out when a report
    cannot be uploaded.
